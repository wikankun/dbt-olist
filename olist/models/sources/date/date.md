...
{% docs date_date_dim_id %}
Calendar date as integer, e.g. 20190202
{% enddocs %}
...
{% docs date_week_of_month %}
Calendar week of month, e.g. '1' for 2019-02-02
{% enddocs %}
...
{% docs date_mmyyyy %}
Calendar date in the format of mmyyyy, e.g. 022019 for '2019-02-02'
{% enddocs %}

{% docs date_mmddyyyy %}
Calendar date in the format of mmddyyyy, e.g. 02042019 for '2019-02-04'
{% enddocs %}

{% docs date_is_weekend %}
